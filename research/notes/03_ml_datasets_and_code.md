...
### 5.1 Классификация звукоизлучающих объектов (многоклассовая)

Классы объектов определяются задачей заказчика. Примеры классов: БПЛА, самолёт, автомобиль, птица, животное, тишина/фон.
