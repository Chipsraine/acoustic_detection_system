# Акустические системы обнаружения дронов: существующие реализации и научная база
...
- **DARPA (США):** Программы ARES и SXCT — акустическое обнаружение малоразмерных БПЛА
- **NATO:** Испытания C-UAS в лагере Suffield (Канада) и Саутгемптоне (Великобритания)
- **Армия США / JIDO:** Контракты с DroneShield для тестирования C-UAS
- **Минобороны РФ:** Работы по акустическим средствам обнаружения БПЛА (НИР, ограниченные данные в открытых источниках)
...
> **"Разработка лёгкой нейросетевой модели совместной локализации и классификации БПЛА по акустическим данным микрофонной решётки для систем реального времени на встраиваемых платформах"**

Обоснование:
- End-to-end multi-task learning на edge мало исследован
- Практическая ценность (компактное устройство $300-500)
- Связь с авиационной тематикой КАИ
- Высокий стартап-потенциал для защиты периметра
